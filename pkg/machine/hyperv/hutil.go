...
var (
	ErrHypervUserNotInAdminGroup             = errors.New("Hyper-V machines require Hyper-V admin rights to be created. Please add the current user to the Hyper-V Administrators group or run Podman as an administrator")
